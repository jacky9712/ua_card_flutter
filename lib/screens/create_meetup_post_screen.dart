...
class _CreateMeetupPostScreenState extends ConsumerState<CreateMeetupPostScreen> {
  ...
  Future<void> _useCurrentLocation() async {
    ...
    if (position == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(context.l10n.locationUnavailable), backgroundColor: Colors.redAccent),
      );
      return;
    }
    setState(() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(context.l10n.locationAttached), backgroundColor: Colors.green),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.l10n.postMeetupTitle, style: TextStyle(fontWeight: FontWeight.bold)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(context.l10n.locationName, style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            if (isLocationCapablePlatform)
              OutlinedButton.icon(
                ...
                label: Text(_lat != null ? context.l10n.coordsAttached : context.l10n.attachCoordsOptional),
              ),
            const SizedBox(height: 20),

            Text(context.l10n.plannedDeckOptional, style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            ...
            Text(context.l10n.time, style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            OutlinedButton.icon(
              onPressed: _pickScheduledTime,
              icon: const Icon(Icons.event, size: 18),
              label: Text(_scheduledAt == null
                  ? context.l10n.pickTimeOptional
            ...
            Text(context.l10n.note, style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            TextField(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                    ...
                    : () async {
                        ...
                        if (success) {
                          ...
                          messenger.showSnackBar(
                            SnackBar(content: Text(l10n.meetupPosted), backgroundColor: Colors.green),
                          );
                        }
                      },
                ...
                child: meetupState.isLoading
                    ...
                    : Text(context.l10n.publish, style: TextStyle(fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
